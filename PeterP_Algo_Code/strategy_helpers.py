...
def interpret_pair_result(trace_rank_95: int, maxeig_rank_95: int) -> str:
    if trace_rank_95 == 1 and maxeig_rank_95 == 1:
        return "Rank-1 cointegration confirmed at 95%."
    if trace_rank_95 == 0 and maxeig_rank_95 == 0:
        return "No cointegration evidence at 95%."
    if trace_rank_95 != maxeig_rank_95:
        return "Mixed evidence at 95%; treat this pair as inconclusive."
    return "Rank 2 outcome; the pair is not suitable for a standard pairs-trading setup."
...
def estimate_roll_spread(
    ...
    *,
    ...
    """Estimate a Roll-model spread in USDT and bps for one asset."""
...
def estimate_roll_spread_rolling(
    ...
    *,
    ...
    """Return a rolling Roll-model spread series in basis points."""
    results = []
...
def run_roll_model(
    ...
    """Run the Roll model for each symbol and collect the summary outputs."""
...
def run_cost_sensitivity_analysis(
    *,
    ...
    """Re-run both strategies at 0.5x, 1.0x, and 2.0x Roll-cost levels."""
